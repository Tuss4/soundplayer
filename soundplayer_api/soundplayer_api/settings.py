"""
Django settings for soundplayer_api project.
...
SECRET_KEY = '@-jq=6+(rti!bry$qbj*a8o$5+a&15ke=&ul%q+z91s%k#f+w0'
...
ROOT_URLCONF = 'soundplayer_api.urls'
...
WSGI_APPLICATION = 'soundplayer_api.wsgi.application'
...
AUTH_USER_MODEL = 'listeners.Listener'
